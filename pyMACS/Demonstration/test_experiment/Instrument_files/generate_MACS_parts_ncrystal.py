...
'''
Below are the original pure UNION method of simulating the monochromator. the Ncrystal version provides phonons as well.
...
monochromator.append_trace("     mosaic = 90, reflections = \"C_graphite.lau\",")
...
COMPONENT NCrystal_mono = NCrystal_process(cfg="'C_sg194_pyrolytic_graphite.ncmat;mos=1.3deg;"
                                                ";dir1=@crys_hkl:0,0,1@lab:0,0,1;dir2=@crys_hkl:1,1,0@lab:0,1,0")
AT (0,0,0) ABSOLUTE

COMPONENT PG_mono = Union_make_material(process_string="Ncrystal_mono",my_absorption=0.0035*4/35.29*100)
AT (0,0,0) ABSOLUTE
...
kidney.append_trace("     mosaic = 80, reflections = \"C_graphite.lau\",")
