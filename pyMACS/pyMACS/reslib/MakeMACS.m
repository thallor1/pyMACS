...
EXP.ana.vmosaic = 50;
%-------------------------   Sample -------------------------------------------------------
EXP.sample.a = 8.9203;  %A: angstroms
EXP.sample.b = 8.9203;
EXP.sample.c = 13.0266;
EXP.sample.alpha = 90;  %Alpha: degrees of arc
EXP.sample.beta = 90;
EXP.sample.gamma = 120;
EXP.sample.mosaic = 40;  %Optional sample mosaic: minutes of arc
EXP.sample.vmosaic = 40;
